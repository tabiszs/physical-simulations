...
public:
	...
	glm::vec3 RungeKutty4(glm::vec3 x, float t, glm::vec3(*func)(glm::vec3, float))
	{
		// k_0 = f(x_n				, t + c_0*dt)
		...
		glm::vec3 k_0 = func(x, t);
		glm::vec3 k_1 = func(x + dt * 0.5f * k_0, t + 0.5f * dt);
		glm::vec3 k_2 = func(x + dt * 0.5f * k_1, t + 0.5f * dt);
		glm::vec3 k_3 = func(x + dt * 1.0f * k_2, t + 1.0f * dt);
		return x + dt * (
			+ b_j[0] * k_0
			+ b_j[1] * k_1
			+ b_j[2] * k_2
	...
	float RungeKutty4(float x, float t, float (*func)(float, float))
	{
		...
		float k_2 = func(x + dt * 0.5f * k_1, t + 0.5f * dt);
		float k_3 = func(x + dt * 1.0f * k_2, t + 1.0f * dt);
		return x + dt * (
			+ b_j[0] * k_0
			+ b_j[1] * k_1
			+ b_j[2] * k_2
