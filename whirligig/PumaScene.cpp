...
void PumaScene::PerformAllFramesOn(std::shared_ptr<Device> device)
{
...
void PumaScene::PerformOneFrameOn(std::shared_ptr<Device> device)
{
	SetLeftViewport();
